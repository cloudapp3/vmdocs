...
As releases usam archives portáveis em vez de pacotes `.deb` ou `.rpm` gerenciados pela distribuição. Use o instalador abaixo ou extraia um archive manualmente.
