---
title: 命令参考
description: vmflow CLI 参考，涵盖前台运行、ctl、tui、mcp、version、update、service 和 uninstall。
---

# 命令参考

vmflow 是一个包含前台运行模式和七个子命令的单二进制程序，别名见下表。
...
| [`tui`](./tui) | `t` | 终端仪表盘。 |
| [`mcp`](./mcp) | - | 为本机运行中的守护进程提供只读 stdio MCP 服务。 |
