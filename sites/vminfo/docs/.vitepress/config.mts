...
const translations: Record<string, Partial<Record<string, string>>> = {
  '': { zh: 'zh/', ja: 'ja/', ru: 'ru/', es: 'es/' },
  'guide/quick-start': { zh: 'zh/quick-start', ja: 'ja/quick-start', ru: 'ru/quick-start', es: 'es/quick-start' },
  'commands/': { zh: 'zh/commands', ja: 'ja/commands', ru: 'ru/commands', es: 'es/commands' },
  'guide/installation': { zh: 'zh/installation', ja: 'ja/installation', ru: 'ru/installation', es: 'es/installation' },
  'guide/overview': { zh: 'zh/overview', ja: 'ja/overview', ru: 'ru/overview', es: 'es/overview' },
  'guide/web-dashboard': { zh: 'zh/web-dashboard', ja: 'ja/web-dashboard', ru: 'ru/web-dashboard', es: 'es/web-dashboard' },
  'guide/deployment': { zh: 'zh/deployment', ja: 'ja/deployment', ru: 'ru/deployment', es: 'es/deployment' },
  'guide/platform-support': { zh: 'zh/platform-support', ja: 'ja/platform-support', ru: 'ru/platform-support', es: 'es/platform-support' },
  'guide/tui-controls': { zh: 'zh/tui-controls', ja: 'ja/tui-controls', ru: 'ru/tui-controls', es: 'es/tui-controls' },
  'api': { zh: 'zh/api', ja: 'ja/api', ru: 'ru/api', es: 'es/api' },
  'commands/summary': { zh: 'zh/summary', ja: 'ja/summary', ru: 'ru/summary', es: 'es/summary' },
  'commands/watch': { zh: 'zh/watch', ja: 'ja/watch', ru: 'ru/watch', es: 'es/watch' },
  'commands/ps': { zh: 'zh/ps', ja: 'ja/ps', ru: 'ru/ps', es: 'es/ps' },
  'commands/kill': { zh: 'zh/kill', ja: 'ja/kill', ru: 'ru/kill', es: 'es/kill' },
  'commands/net': { zh: 'zh/net', ja: 'ja/net', ru: 'ru/net', es: 'es/net' },
  'commands/update': { zh: 'zh/update', ja: 'ja/update', ru: 'ru/update', es: 'es/update' },
  'library/': { zh: 'zh/library', ja: 'ja/library', ru: 'ru/library', es: 'es/library' },
  'library/collect': { zh: 'zh/collect', ja: 'ja/collect', ru: 'ru/collect', es: 'es/collect' },
  'library/embed-tui': { zh: 'zh/embed-tui', ja: 'ja/embed-tui', ru: 'ru/embed-tui', es: 'es/embed-tui' },
};
